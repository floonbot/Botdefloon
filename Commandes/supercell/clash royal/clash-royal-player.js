...
const api = new ClashRoyaleAPI(config.ApiR);  //pour l'api https://developer.clashroyale.com/#/account
const { logocr, supercellLogo } = require("../../../json/emoji.json");

module.exports = {

    name: "clash-royal-player",
    ...
    async run(bot, message, args) {
        ...
        try {
            ...
            ${logocr} **Les informations du joueur :**
