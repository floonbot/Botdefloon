      ...
      try {
        ...
        if (classe !== "guerrier" && classe !== "tank" && classe !== "mage") {
          let mauvais = new Discord.EmbedBuilder()
            .setTitle(`**__Les category des classe dispo__**}`)
            .setColor("#000000")
          ...
          message.followUp(`Le nom du personnage ${name}, la race ${race}, la classe de ${classe} et la description ont bien étais définie`)
        }
